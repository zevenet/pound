...
#else
#error                                                                         \
    "You have libpcreposix, but the header files are missing. Use --disable-pcreposix"
#endif
#elif HAVE_REGEX_H
#include <regex.h>
#else
 ...
 */
extern void addr2IpAndPort(char *, int *, const int, const struct addrinfo *);
